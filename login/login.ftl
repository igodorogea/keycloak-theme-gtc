...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=(realm.password && social.providers??); section>
    <#if section = "header">
        ${msg("doLogIn")}
    <#elseif section = "form">
        <figure class="kc-logo"><img src="${url.resourcesPath}/img/logo.png" alt="Globaltrade Platform"></figure>
        <div class="kc-container">
            <div class="kc-hero">
                <figure class="kc-hero-wrapper"><img src="${url.resourcesPath}/img/hero.jpg"
                            alt="Globaltrade hero image"></figure>
                <p>Welcome Screen</p>
            </div>
            <div id="kc-form"
                        ...
                        <ul class="${properties.kcFormSocialAccountListClass!} <#if social.providers?size gt 4>${properties.kcFormSocialAccountDoubleListClass!}</#if>">
                            <#list social.providers as p>
                                <li class="${properties.kcFormSocialAccountListLinkClass!}">
                                    <#assign displayName=properties.microsoftIdPDisplayName! />
                                    <a href="${p.loginUrl}" id="zocial-${p.alias}"
                                            class="zocial ${p.providerId}"><span><#if displayName?has_content>${displayName}<#else>${p.displayName}</#if></span></a>
                                </li>
                            </#list>
                        </ul>
                    </div>
                    <div class="kc-alt-option"><span>Or</span></div>
                </#if>
